...
const nav = JSON.parse(readFileSync(join(__dirname, "nav.json"), "utf-8"));
...
export default defineConfig({
  ...
  head: [
    ...
    [
      "meta",
      {
        ...
        content: "A curated collection of excellent JavaScript code examples for frontend, backend, git automation, and Node.js development",
      },
    ],
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/ropean/scripts" }],
    ...
    footer: {
      ...
      copyright: 'Built with <a href="https://vitepress.dev/">VitePress</a> by <a href="https://ropean.org/">ropean</a> © 2025',
    },
  },
});
